...
| `AI_Prompts_for_Attribute_Scoring.md` | Ready-to-use LLM prompts (ChatGPT / Copilot / Claude) for scoring the 20 AI-suitable attributes. Includes both 8 grouped prompts (covering multiple fields per call) and 20 individual prompts (one per attribute). |
